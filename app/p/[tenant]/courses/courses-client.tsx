...
// Tenant-branded course catalog. Mirrors the global /courses layout
// (editorial hero, trending-category chip rail, featured top-pick
// strip, image-forward grid) so the discovery UX is consistent across
// the platform and every tenant portal. Tenant chrome (logo header,
// announcement bar, footer) is supplied by the surrounding /p/[tenant]
// layout — this page only renders the catalog itself.
  ...
  return (
    <div>
      <DynamicMeta
        ...
        description={`Browse every course on ${brand.name} — hand-picked classes from working teachers and creators.`}
        image={brand.logoUrl}
        siteName={brand.name}
        type="website"
      />
