...
const TABS: TabDef[] = [
  {
    ...
    cards: [
      { icon: Video,         title: "Live cohorts",       body: "Zoom / Meet sessions with attendance, recordings, and roll-call.",              href: "/features/live-classes", badges: ["Zoom & Meet", "Attendance"],    accent: "coral" },
      { icon: BookOpen,      title: "Self-paced courses", body: "Modules + lessons + quizzes. Drip schedule, certificate on completion.",        href: "/features/courses",       badges: ["Drip Schedule", "Auto Graded"], accent: "teal" },
      ...
      { icon: Download,      title: "Digital downloads",  body: "Sell PDFs, templates, Notion docs — one-time price, instant delivery.",          href: "/features/downloads",     badges: ["Instant Access", "Any Format"], accent: "sky" },
  ...
  },
  {
    ...
    cards: [
      { icon: Wallet,        title: "UPI checkout",  body: "Razorpay UPI as the default. Zero friction for Indian students.",            href: "/features/checkout",     badges: ["UPI & Netbanking", "Zero Setup"],       accent: "amber" },
  ...
  },
  {
    ...
    cards: [
      { icon: Video,         title: "Cloud live room",     body: "Built-in LiveKit room — no Zoom signup, students join with a name. Adaptive 1080p.",  href: "/features/live-classes", badges: ["No Signup", "1080p Adaptive"],       accent: "coral" },
      ...
      { icon: PenSquare,     title: "Whiteboard",          body: "Real-time multiplayer whiteboard. Sketch, diagram, teach — saved per session.",         href: "/features/whiteboard",   badges: ["Multiplayer", "Autosave"],            accent: "amber" },
      ...
      { icon: AtSign,        title: "Cohort community",    body: "Per-batch room with @-mentions, file previews, post editing. Slack-grade.",            href: "/features/community",    badges: ["@-mentions", "File previews"],        accent: "emerald" },
    ],
  },
]
